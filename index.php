...
$result = mysqli_query($conn, "SELECT * FROM cv_gian WHERE id=1"); // Sesuaikan dengan id CV
...
<body class="p-3">
  <nav class="navbar sticky-top bg-body-tertiary biru">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="admin.php"><strong>Update</strong></a>
    </div>
  </nav>
  <div class="card" style="background-color: black">
    <div class="p-3">
      <img class="w-200p h-200p rounded-circle border border-light" src="<?php echo $data['foto_path']; ?>" alt="Foto Profil">
      <div class="card-body" >
